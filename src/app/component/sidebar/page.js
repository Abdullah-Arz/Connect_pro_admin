...
function page() {
  ...
  const Menus = [
    ...
    { id: 4, title: "User Requests", icon: <TbUsersPlus  />,link:'/user_request' },
    { id: 5, title: "Rejected Users", icon: <TbUserOff />,link:'/rejected_users' },
  ...
  return (
    <div>
      <div
        className={`bg-[#23303F] h-screen p-5 pt-8 ${
            ...
            <div key={index}>
             <Tooltip
              ...
              <li
                ...
                className={` ${currentRoute === item.link ? "text-sm text-[#d39254] flex items-center gap-x-4 p-2 mt-4 cursor-pointer bg-transparent border border-[#d39254] rounded-md duration-100": "text-sm text-[#73858F] flex items-center border-0 gap-x-4 p-2 mt-4 cursor-pointer  hover:text-[#d39254] rounded-md duration-100"} `}
              >
