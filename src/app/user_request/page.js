...
import User_request_table from "../component/user_request_table/page";
...
function Page() {
  ...
  useLayoutEffect(() => {
    async function retrieveData() {
      try {
        const response = await axios.get(`${api}/user/pro_profile_request/`, {
          headers,
        });
