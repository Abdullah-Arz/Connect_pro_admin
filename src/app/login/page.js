      ...
      {isLoading ? (
        ...
        <div className="bg-[#73858F] h-screen">
          ...
          <div className="md:flex bg-[#0E0F12]  h-full w-full shadow-lg">
            ...
            <div className="bg-[#23303F]   sm:w-2/4 md:w-2/4 lg:w-2/4 xl:w-2/4 2xl:w-2/4">
              <img
                src="/icon_full.png"
                alt="Phone image"
                className="w-full h-full p-[25%]   bg-[#23303F]"
              />  
            </div>
            <div className="flex sm:w-2/4  md:w-2/4 lg:w-2/4 xl:w-2/4 2xl:w-2/4  justify-center items-center">
            
              <form
                className="bg-[#0E0F12]  w-full px-14 py-14"
                onSubmit={(e) => submitData(e)}
              >
                <h1 className="2xl:text-xl text-3xl font-normal text-white mt-32 mb-10">
